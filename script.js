...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        zh: {
            ...
            join_btn: '加入我们',
            join_title: '加入 TurboNeko Studio',
            join_desc: '无论你是技术宅、车迷、二次元同好，<br>还是单纯想找个地方一起整活——',
            join_qq_label: 'QQ 群',
            join_qq_hint: '点击一键加群',
            join_email_label: 'Email',
            join_email_hint: '发送邮件加入',
            join_footer: '不跟风，不将就，不画大饼。<br>Speed Meets Style. 🚀',
        ...
        en: {
            ...
            join_btn: 'Join Us',
            join_title: 'Join TurboNeko Studio',
            join_desc: 'Tech enthusiast, car lover, anime fan,<br>or just looking for a place to create together—',
            join_qq_label: 'QQ Group',
            join_qq_hint: 'Click to join',
            join_email_label: 'Email',
            join_email_hint: 'Send an email',
            join_footer: 'No trends, no compromise, no empty promises.<br>Speed Meets Style. 🚀',
